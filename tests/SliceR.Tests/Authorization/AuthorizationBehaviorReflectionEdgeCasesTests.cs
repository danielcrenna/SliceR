...
public class AuthorizationBehaviorReflectionEdgeCasesTests
{
    ...
    {
        public Task<TestDocument?> ResolveAsync(ValidResourceRequest request, CancellationToken cancellationToken) => throw new InvalidOperationException("Resolver failed");
    }
